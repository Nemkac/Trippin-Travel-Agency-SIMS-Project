...
namespace InitialProject.DTO
{
    public class TourRequestDTO
    {
        ...
        public TourRequestDTO(string tura, string city, string country, language language, string dateFrom, string dateTo, string acceptedDate, TourRequestStatus status)
        {
            this.tura = tura;
            this.city = city;
            this.country = country;
